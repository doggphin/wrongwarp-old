...
namespace WrongWarp {
    public class Portal : MonoBehaviour {
        ...
        [SerializeField] public int recursionLimit = 5;
        [SerializeField] public BoxCollider portalCollider;
        ...
        public static Action<Portal> portalCreated = delegate { };
        public static Action<Portal> portalDestroyed = delegate { };
        public bool isInitialized = false;

        public void Init()
        {
            playerCam = WWHelpers.playerCamera;
        ...
        void HandleTravellers() {
            ...
            for (int i = 0; i < trackedTravellers.Count; i++)
            {
                ...
                if (portalSide != portalSideOld)
                {
                    ...
                    traveller.graphicsClone.transform.SetPositionAndRotation(positionOld + traveller.graphicsObjectOffset, rotOld);
                ...
                else
                {
                    ...
                    traveller.graphicsClone.transform.position += traveller.graphicsObjectOffset;
        ...
        /// <para> Called after PrePortalRender, and before PostPortalRender </para>
        /// </summary>
        ...
        void CreateViewTexture() {
            if (viewTexture == null || viewTexture.width != Screen.width || viewTexture.height != Screen.height) {
                ...
                viewTexture = RenderTexture.GetTemporary(Screen.width, Screen.height, 0);
